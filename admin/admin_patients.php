        ...
        <div class="modal-body">
          <form id="addPatientForm" method="post" action="">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="patientAge" name="patientAge" readonly>
            </div>
            <div class="mb-3">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id="viewPatientModalBody">
          ...
          <p><strong>Admission Type:</strong> <span id="admissionTypeDisplay"></span></p>
          <p><strong>Status:</strong> <span id="patientStatusDisplay"></span></p>
...
<script>
  ...
  document.getElementById('patientFilterForm').addEventListener('submit', function(event) {
    ...
    fetch('/lguHealth/api/patients_management/list_patients.php', {
        method: 'POST',
        headers: {
  ...
  function viewDetails(patientId) {
    $.post("/lguHealth/api/patients_management/get_patient.php", {
      patientId: patientId
      ...
      document.getElementById('admissionTypeDisplay').textContent = patient.admission_type;
      document.getElementById('patientStatusDisplay').textContent = patient.status;
      ...
      document.getElementById('patientAgeDisplay').textContent = age;
      document.getElementById('editPatientButton').href = `admin_edit_patient.php?id=${patient.patient_id}`;
      $('#viewPatientModal').modal('hide'); // Hide modal before showing it
