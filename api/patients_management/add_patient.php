...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        // Prepare and execute the query to insert the patient
        ...
        if ($stmt->execute()) {
            // Log the action
            $logMessage = "New patient registered: Name - {$patientName}, DOB - {$patientDob}, Gender - {$patientGender}, Contact - {$patientContact}, Address - {$patientAddress}";
            logAction($logMessage);  // Call the log function to record the action
